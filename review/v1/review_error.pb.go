...
const file_api_review_v1_review_error_proto_rawDesc = "" +
	"\n" +
	" api/review/v1/review_error.proto\x12\rapi.review.v1\x1a\x13errors/errors.proto*\x95\x01\n" +
	"\vErrorReason\x12\x11\n" +
	"\aUNKNOWN\x10\x00\x1a\x04\xa8E\xf4\x03\x12\x18\n" +
	"\x0eUSER_NOT_FOUND\x10\x01\x1a\x04\xa8E\x94\x03\x12\x1d\n" +
	"\x13USER_ALREADY_EXISTS\x10\x02\x1a\x04\xa8E\x99\x03\x12\x1a\n" +
	"\x10INVALID_ARGUMENT\x10\x03\x1a\x04\xa8E\xa6\x03\x12\x18\n" +
